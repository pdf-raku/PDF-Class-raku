...
class PDF::Struct::ColorSpace::DeviceN
    ...
    has PDF::Struct::Function $.TintTransform is index(3, :required);

    my role DeviceNDict {...} # see below
    has DeviceNDict $.Attributes is index(4);

    use PDF::Struct::ColorSpace::Separation;
