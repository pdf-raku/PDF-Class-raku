...
my $doc = PDF::Doc.open: "t/pdf/colorspace-devicen.in";
my %cs = $doc.Root.Pages.resources: 'ColorSpace';

my $cs1 = %cs<CS1>;
does-ok $cs1, ::('PDF::Doc::Type::ColorSpace::DeviceN');
...
isa-ok $tint-transform, ::('PDF::Doc::Type::Function::Sampled');
...
isa-ok $magenta, ::('PDF::Doc::Type::ColorSpace::Separation'), '.Colorants<Magenta>';
