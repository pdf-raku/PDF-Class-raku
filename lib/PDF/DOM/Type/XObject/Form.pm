...
class PDF::DOM::Type::XObject::Form
    ...
    has Numeric @.BBox is entry(:required); #| (Required) An array of four numbers in the form coordinate system (see above), giving the coordinates of the left, bottom, right, and top edges, respectively, of the form XObject’s bounding box.
    has Numeric @.Matrix is entry;          #| (Optional) An array of six numbers specifying the form matrix, which maps form space into user space
