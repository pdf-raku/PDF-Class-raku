...
role PDF::AcroForm
    ...
    my subset XFALike where PDF::COS::Stream | Array;
    has XFALike $.XFA is entry;          # (Optional; PDF 1.5) A stream or array containing an XFA resource, whose format is described by the Data Package (XDP) Specification.
