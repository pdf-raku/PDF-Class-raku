...
class PDF::DOM::Type::ColorSpace::CalRGB
   ...
   role CalRGBDict
       ...
       has Numeric $.Gamma is entry;                           #| (Optional) An array of three numbers [ GR GG GB ] specifying the gamma for the red, green, and blue (A, B, and C) components of the color space. Default value: [ 1.0 1.0 1.0 ].
