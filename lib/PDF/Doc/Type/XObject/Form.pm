...
class PDF::Doc::Type::XObject::Form
    ...
    has PDF::Doc::Type::Resources $.Resources is entry;          #| (Optional but strongly recommended; PDF 1.2) A dictionary specifying any resources (such as fonts and images) required by the form XObject
