...
class PDF::Doc::Contents::Gfx 
    ...
    method load-image(Str $spec ) {
        PDF::Doc::Type::XObject::Image.open( $spec );
    }

    method inline-images {
	my PDF::Doc::Type::XObject::Image @images;
	for $.ops.keys -> $i {
	    my $v = $.ops[$i];
	    ...
	    @images.push: PDF::Doc::Type::XObject::Image.new( :$dict, :$encoded );
	}
	@images;
    }
    ...
    method do(PDF::Doc::Type::XObject $obj!,
              Numeric $x = 0,
              Numeric $y = 0,
