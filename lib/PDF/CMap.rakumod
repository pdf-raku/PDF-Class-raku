...
my subset CMapRef is export(:CMapRef) where PDF::COS::Name | PDF::CMap;
has CMapRef $.UseCMap is entry;                  # (Optional) The name of a predefined CMap, or a stream containing a CMap, that is to be used as the base for this CMap
