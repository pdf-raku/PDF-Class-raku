...
isa-ok $catalog, ::('PDF::Doc::Type')::('Catalog');
...
does-ok $acroform, ::('PDF::Doc::Type::AcroForm'), '$.AcroForm role';
is-json-equiv $acroform.Fields, [], '$.AcroForm.Fields';

my $viewer-preferences = $catalog.ViewerPreferences;
does-ok $viewer-preferences, ::('PDF::Doc::Type::ViewerPreferences'), '$.ViewerPreferences role';
...
does-ok $catalog.OpenAction, ::('PDF::Doc::Type')::('Action::GoTo');
...
lives-ok {$catalog = ::('PDF::Doc::Type::Catalog').new( :$dict )}, 'catalog .new with valid /Type - lives';
$dict<Type>:delete;

lives-ok {$catalog = ::('PDF::Doc::Type::Catalog').new( :$dict )}, 'catalog .new default /Type - lives';
isa-ok $catalog.Type, Str, 'catalog $.Type';
