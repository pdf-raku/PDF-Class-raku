...
class PDF::Struct::Page
    ...
    has PDF::Struct::Resources $.Resources is entry(:inherit);     #| (Required; inheritable) A dictionary containing any resources required by the page
    ...
    has PDF::Struct::Annot @.Annots is entry; #| (Optional) An array of annotation dictionaries representing annotations associated with the page
