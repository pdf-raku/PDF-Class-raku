...
class PDF::DOM::Type::Function::Sampled
    is PDF::DOM::Type::Function {

    use PDF::Object::Tie;
    # see [PDF 1.7 TABLE 3.36 Additional entries specific to a type 0 function dictionary]

    has Array $!Size is entry(:required); #| (Required) An array of m positive integers specifying the number of samples in each input dimension of the sample table.
    ...
    has Array $!Encode is entry;          #| (Optional) An array of 2 × m numbers specifying the linear mapping of input values into the domain of the function’s sample table. Default value: [ 0 (Size0 − 1) 0 (Size1 − 1) … ].

    has Array $!Decode is entry;          #| (Optional) An array of 2 × n numbers specifying the linear mapping of sample values into the range appropriate for the function’s output values. Default value: same as the value of Range.
