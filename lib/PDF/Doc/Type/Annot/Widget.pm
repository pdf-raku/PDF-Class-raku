...
class PDF::Doc::Type::Annot::Widget
    ...
    has PDF::Doc::Type::Border $.BS is entry;            #| (Optional; PDF 1.2) A border style dictionary specifying the width and dash pattern to be used in drawing the annotation’s border.
