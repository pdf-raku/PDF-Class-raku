...
##						     :ReadOnly(7) :Locked(8) :ToggleNoView(9) :LockedContents(10) »;
    ...
    use PDF::Struct::Appearance;
    has PDF::Struct::Appearance $.AP is entry;                 #| (Optional; PDF 1.2) An appearance dictionary specifying how the annotation is presented visually on the page
