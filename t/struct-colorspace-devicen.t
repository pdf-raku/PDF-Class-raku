...
my $cs1 = %cs<CS1>;
does-ok $cs1, ::('PDF::Struct::ColorSpace::DeviceN');
...
isa-ok $tint-transform, ::('PDF::Struct::Function::Sampled');
...
isa-ok $magenta, ::('PDF::Struct::ColorSpace::Separation'), '.Colorants<Magenta>';
