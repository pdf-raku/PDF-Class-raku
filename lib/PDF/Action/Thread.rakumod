...
class PDF::Action::Thread
    ...
    multi sub coerce($_, ThreadLike) is default { fail "unable to coerce {.raku} to a Thread" }
    ...
    multi sub coerce-bead($_, BeadLike) is default { fail "unable to coerce {.raku} to a Bead" }
