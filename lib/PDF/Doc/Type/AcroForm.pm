...
use PDF::Doc::Type; # just to help rakudo
use PDF::DAO::Tie;
use PDF::DAO::Tie::Hash;

# AcroForm role - see PDF::Doc::Type::Catalog - /AcroForm entry

role PDF::Doc::Type::AcroForm
    does PDF::DAO::Tie::Hash {

    # see [PDF 1.7 TABLE 8.67 Entries in the interactive form dictionary]
    use PDF::Doc::Type::Field :coerce;
    use PDF::DAO;

    has PDF::Doc::Type::Field @.Fields is entry(:required, :&coerce);    #| (Required) An array of references to the document’s root fields (those with no ancestors in the field hierarchy).
    #| returns an inorder array of all desendant fields
    method fields returns Seq {
	my PDF::Doc::Type::Field @fields;
	for $.Fields.keys {
