...
isa-ok $text-annot, ::('PDF::Struct::Annot::Text');
...
my $open-text-annot = ::('PDF::Struct::Annot::Text').new(:dict{
...
$pdf.save-as('t/struct-annot.pdf');
...
isa-ok $link-annot, ::('PDF::Struct::Annot::Link');
