...
class PDF::Font::Type0
    ...
    has CMapLike $.Encoding is entry(:required);        # (Required) The name of a predefined CMap, or a stream containing a CMap that maps character codes to font numbers and CIDs.
