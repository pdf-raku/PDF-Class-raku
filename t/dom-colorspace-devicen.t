...
my $doc = PDF::DOM.open: "t/pdf/colorspace-devicen.in";
my %cs = $doc.Root.Pages.resources: 'ColorSpace';

my $cs1 = %cs<CS1>;
does-ok $cs1, ::('PDF::DOM::Type::ColorSpace::DeviceN');
...
isa-ok $tint-transform, ::('PDF::DOM::Type::Function::Sampled');
...
isa-ok $magenta, ::('PDF::DOM::Type::ColorSpace::Separation'), '.Colorants<Magenta>';
