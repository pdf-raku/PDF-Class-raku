...
class PDF::Doc::Type::Catalog
    ...
    has PDF::Doc::Type::ViewerPreferences $.ViewerPreferences is entry;  #| (Optional; PDF 1.2) A viewer preferences dictionary specifying the way the document is to be displayed on the screen.
    ...
    use PDF::Doc::Type::Outlines;
    has PDF::Doc::Type::Outlines $.Outlines is entry(:indirect); #| (Optional; must be an indirect reference) The outline dictionary that is the root of the document’s outline hierarchy
    ...
    use PDF::Doc::Type::Action :coerce;
    has PDF::Doc::Type::Action::Destination $.OpenAction is entry(:&coerce);               #| (Optional; PDF 1.1) A value specifying a destination to be displayed or an action to be performed when the document is opened.
    ...
    use PDF::Doc::Type::AcroForm;
    has PDF::Doc::Type::AcroForm $.AcroForm is entry;    #| (Optional; PDF 1.2) The document’s interactive form (AcroForm) dictionary
    ...
    has PDF::Doc::Type::Resources $.Resources is entry;
