...
isa-ok $ximage-obj, ::('PDF::Doc::Type')::('XObject::Image');
...
my $snoopy = ::('PDF::Doc::Type')::('XObject::Image').open("t/images/snoopy-happy-dance.jpg");
...
my $image = @images[1];
isa-ok $image, ::('PDF::Doc::Type')::('XObject::Image');
...
$pdf.save-as('t/doc-xobject-image.pdf');
