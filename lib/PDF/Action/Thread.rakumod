...
multi sub coerce($_, ThreadLike) { warn "unable to coerce {.raku} to a Thread" }
...
multi sub coerce-bead($_, BeadLike) { warn "unable to coerce {.raku} to a Bead" }
