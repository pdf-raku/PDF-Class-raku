...
class PDF::DOM
    ...
    has PDF::DOM::Type::Catalog $!Root is entry(:required,:indirect); #| (Required; must be an indirect reference) The catalog dictionary for the PDF document contained in the file
