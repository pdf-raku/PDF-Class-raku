...
##						     :ReadOnly(7) :Locked(8) :ToggleNoView(9) :LockedContents(10) »;
    ...
    use PDF::Doc::Type::Appearance;
    has PDF::Doc::Type::Appearance $.AP is entry;                 #| (Optional; PDF 1.2) An appearance dictionary specifying how the annotation is presented visually on the page
