...
isa-ok $tt-font-obj, ::('PDF::Struct::Font::TrueType');
...
class SubclassedType1Font is PDF::Struct::Font::Type1 {};
...
isa-ok $enc-obj, ::('PDF::Struct::Encoding');
...
isa-ok $objr-obj, ::('PDF::Struct::OBJR');
...
isa-ok $oi-font-obj, ::('PDF::Struct::OutputIntent');
...
use PDF::Struct::Page;
use PDF::Struct::XObject::Form;
use PDF::Struct::XObject::Image;
...
isa-ok $gs-obj, ::('PDF::Struct::ExtGState');
