...
isa-ok PDF::Zen.loader.load( :dict{ :Type<Page> }), ::('PDF::Page'), 'delegation sanity';
isa-ok PDF::Zen.loader.load( :dict{ :Type<XObject>, :Subtype<Image> }), ::('PDF::XObject::Image'), 'delegation to subclass';
isa-ok PDF::Zen.loader.load( :dict{ :ShadingType(7) }),  ::('PDF::Shading::Tensor'), 'delegation by ShadingType';
isa-ok PDF::Zen.loader.load( :dict{ :ShadingType(42) }),  ::('PDF::Shading'), 'delegation by ShadingType (unknown)';
isa-ok PDF::Zen.loader.load( :dict{ :Type<Unknown> }, :fallback(Hash)), Hash, 'delegation fallback';
