...
class PDF::Struct::Font::Type0
	...
	has PDF::DAO::Name $.BaseFont is entry(:required); #| (Required) The PostScript name of the font. In principle, this is an arbitrary name, since there is no font program associated directly with a Type 0 font dictionary.
        use PDF::Struct::CMap;
	subset NameOrCMap of PDF::DAO where PDF::DAO::Name | PDF::Struct::CMap;
	...
	has PDF::Struct::Font @.DescendantFonts is entry(:required,:len(1));    #| (Required) A one-element array specifying the CIDFont dictionary that is the descendant of this Type 0 font.
