...
my $hbi-afm = PDF::Basic::Util::Font::core-font( :family<Helvetica>, :weight<Bold>, :style<Italic> );
...
my $zapf = PDF::Basic::Util::Font::core-font( 'ZapfDingbats' );
...
my $sym = PDF::Basic::Util::Font::core-font( 'Symbol' );
