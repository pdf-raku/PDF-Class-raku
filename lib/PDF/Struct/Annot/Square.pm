...
class PDF::Struct::Annot::Square
    ...
    has PDF::Struct::Border $.BS is entry;              #| (Optional) A border style dictionary (see Table 8.17 on page 611) specifying the line width and dash pattern to be used in drawing the rectangle or ellipse.
