...
class PDF::Doc::Type::Pattern::Tiling
    is PDF::DAO::Stream
    ...
    has PDF::Doc::Type::Resources $.Resources is entry(:required);        #| (Required) A resource dictionary containing all of the named resources required by the pattern’s content stream (see Section 3.7.2, “Resource Dictionaries”).
}
