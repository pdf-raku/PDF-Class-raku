...
class PDF::Struct::Font::CIDFontType0
    is PDF::Struct::Font {
    ...
    has PDF::Struct::FontDescriptor $.FontDescriptor is entry(:required, :indirect); #| (Required; must be an indirect reference) A font descriptor describing the CIDFont’s default metrics other than its glyph widths
