...
isa-ok $color-space-obj, ::('PDF::Doc::Type')::('ColorSpace::CalRGB');
...
require ::('PDF::Doc::Type')::('ColorSpace::CalGray');
my $cal-gray = ::('PDF::Doc::Type')::('ColorSpace::CalGray').new;
isa-ok $cal-gray, ::('PDF::Doc::Type')::('ColorSpace::CalGray'), 'new CS class';
...
isa-ok $color-space-obj, ::('PDF::Doc::Type')::('ColorSpace::ICCBased');
is $color-space-obj.type, 'ColorSpace', '$.type accessor';
...
is $ind-obj.gen-num, 0, '$.gen-num';
$color-space-obj = $ind-obj.object;
isa-ok $color-space-obj, ::('PDF::Doc::Type')::('ColorSpace::Indexed');
is $color-space-obj.type, 'ColorSpace', '$.type accessor';
...
is $ind-obj.gen-num, 0, '$.gen-num';
$color-space-obj = $ind-obj.object;
isa-ok $color-space-obj, ::('PDF::Doc::Type')::('ColorSpace::Separation');
is $color-space-obj.type, 'ColorSpace', '$.type accessor';
...
$ind-obj = PDF::Storage::IndObj.new( |%ast, :$reader);
$color-space-obj = $ind-obj.object;
isa-ok $color-space-obj, ::('PDF::Doc::Type')::('ColorSpace::DeviceN');
...
does-ok $orange-seperation, ::('PDF::Doc::Type')::('ColorSpace::Separation'), 'seperation (Orange)';

# build from scratch
use PDF::Doc::Type::Function::Exponential;
my $exp-func = PDF::Doc::Type::Function::Exponential.new: { :Domain[ 0, 1], :Range[flat (0.0, 1.0) xx 4], :C0[0.0 xx 4], :C1[0.85, 0.24, 0.0, 0.0], :N(1.0) };
is $exp-func.FunctionType, 2, '$exp-func.FunctionType';
my $cs1 = ::('PDF::Doc::Type')::('ColorSpace::Separation').new: [ 'Separation', 'My Spot 1', :name<DeviceCMYK>, $exp-func ];
