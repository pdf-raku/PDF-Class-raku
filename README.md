...
PDF::Filespec | dict | CI, DOS, Desc, EF(embedded-files), F(file-name), FS(file-system), ID, Mac, RF(related-files), Type(type), UF, Unix, V(volatile) |  |  | ISO_32000::File_specification
...
PDF::FontDescriptor::CID | dict | CIDSet, FD, Lang, Style |  |  | ISO_32000::CIDFont_descriptor_additional
...
PDF::ICCProfile | dict | Alternate, Metadata, N(num-colors), Range |  |  | ISO_32000::ICC_profile
...
PDF::Info | dict | Title, Author, CreationDate, Creator, Keywords, ModDate, Producer, Subject, Trapped  |  |  | ISO_32000::Info
...
PDF::Signature | dict | ByteRange, Cert, Changes, ContactInfo, Contents, Location, M(date-signed), Name, Prop_AuthTime, Prop_AuthType, Prop_Build, R, Reason, Reference, SubFilter, Type, V |  |  | ISO_32000::Signature
...
PDF::StructElem | dict | A(attributes), ActualText, Alt(alternative-description), C, E(expanded-form), ID, K(kids), Lang, P(parent), Pg(page), R(revision), S(tag), T(title), Type |  | | ISO_32000::Structure_tree_element
