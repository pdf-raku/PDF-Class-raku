...
PDF::Catalog::AdditionalActions | dict | DP(did-print), DS(did-save), WC(will-close), WP(will-print), WS(will-save) |  |  | Table_197-Entries_in_the_document_catalogs_additional-actions_dictionary
...
PDF::Annot::AdditionalActions | dict | Bl(blur), D(mouse-down), E(enter), Fo(focus), PC(page-close), PI(page-invisable), PO(page-open), PV(page-visable), U(mouse-up), X(exit) |  |  | Table_194-Entries_in_an_annotations_additional-actions_dictionary
