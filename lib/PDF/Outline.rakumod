...
role PDF::Outline
    ...
    has DestSpec $.Dest is entry(:alias<destination>, :coerce(&coerce-dest));              # (Optional; not permitted if an A entry is present) The destination to be displayed when this item is activated
