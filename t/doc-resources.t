...
plan 63;
require ::('PDF::Doc::Type::Catalog');
my $dict = { :Outlines(:ind-ref[2, 0]), :Type( :name<Catalog> ), :Pages{ :Type( :name<Pages> ) } };
my $catalog-obj = ::('PDF::Doc::Type::Catalog').new( :$dict );
...
isa-ok $tt-font-obj, ::('PDF::Doc::Type::Font::TrueType');
...
class SubclassedType1Font is PDF::Doc::Type::Font::Type1 {};
...
isa-ok $enc-obj, ::('PDF::Doc::Type::Encoding');
...
isa-ok $objr-obj, ::('PDF::Doc::Type::OBJR');
...
isa-ok $oi-font-obj, ::('PDF::Doc::Type::OutputIntent');
...
my $new-page = PDF::Doc::Type::Page.new;
my $form1 = PDF::Doc::Type::XObject::Form.new( :dict{ :BBox[0, 0, 100, 120] } );
...
isa-ok $gs-obj, ::('PDF::Doc::Type::ExtGState');
...
use PDF::Doc::Type::ColorSpace::Lab;
my $colorspace = PDF::Doc::Type::ColorSpace::Lab.new;
isa-ok $colorspace, PDF::Doc::Type::ColorSpace::Lab;
my $cs1 = $new-page.use-resource( $colorspace );
is $cs1.key, 'CS1', 'ColorSpace resource entry';

use PDF::Doc::Type::Shading::Axial;
my $Shading = PDF::Doc::Type::Shading::Axial.new( :dict{ :ColorSpace(:name<DeviceRGB>),
...
use PDF::Doc::Type::Pattern::Shading;
my $pat-obj = PDF::Doc::Type::Pattern::Shading.new( :dict{ :PaintType(1), :TilingType(2), :$Shading } );
my $pt1 = $new-page.use-resource( $pat-obj );
is $pt1.key, 'Pt1', 'Shading resource entry';

my $resources = $new-page.Resources;
does-ok $resources, ::('PDF::Doc::Type::Resources'), 'Resources type';
