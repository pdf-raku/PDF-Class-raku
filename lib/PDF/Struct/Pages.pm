...
class PDF::Struct::Pages
    ...
    has PDF::Graphics::PageNode @.Kids is entry(:required, :indirect);  #| (Required) An array of indirect references to the immediate children of this node. The children may be page objects or other page tree nodes.
