...
my $hbi-afm = PDF::Graphics::Font::core-font( :family<Helvetica>, :weight<Bold>, :style<Italic> );
...
my $zapf = PDF::Graphics::Font::core-font( 'ZapfDingbats' );
...
my $sym = PDF::Graphics::Font::core-font( 'Symbol' );
