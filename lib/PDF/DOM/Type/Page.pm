...
class PDF::DOM::Type::Page
    ...
    has Array $!Annots is entry;                 #| (Optional) An array of annotation dictionaries representing annotations associated with the page
    ...
    has PDF::Object::Stream $!Metadata is entry; #| (Optional; PDF 1.4) A metadata stream containing metadata for the page
    ...
    has PDF::Object::Name $!Tabs is entry;       #| (Optional; PDF 1.5) A name specifying the tab order to be used for annotations on the page
    has PDF::Object::Name $!TemplateInstantiated is entry; #| (Required if this page was created from a named page object; PDF 1.5) The name of the originating page object
