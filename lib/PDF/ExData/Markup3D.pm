...
class PDF::ExData::Markup3D
    ...
    has PDF::COS::Name  $.Type is entry where 'ExData'; # The type of PDF object that this dictionary describes; if present, is ExData for an external data dictionary.
