...
class PDF::DOM::Type::Font::CIDFontType0
    ...
    use PDF::DOM::Type::FontDescriptor;
    has PDF::DOM::Type::FontDescriptor $.FontDescriptor is entry(:required, :indirect); #| (Required; must be an indirect reference) A font descriptor describing the CIDFont’s default metrics other than its glyph widths
