...
class PDF::Struct::Font::Type3
    ...
    my subset NameOrEncoding of Any where PDF::DAO::Name | PDF::Struct::Encodiing;
    ...
    has PDF::Struct::FontDescriptor $.FontDescriptor is entry(:indirect);     #| (Required in Tagged PDF documents; must be an indirect reference) A font descriptor describing the font’s default metrics other than its glyph widths

    use PDF::Struct::Resources;
    has PDF::Struct::Resources $.Resources is entry;   #| (Optional but strongly recommended; PDF 1.2) A list of the named resources, such as fonts and images, required by the glyph descriptions in this font
