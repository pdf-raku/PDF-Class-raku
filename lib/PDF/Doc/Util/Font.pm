...
module PDF::Doc::Util::Font {
    use PDF::Doc::Util::Font::Encodings;
    ...
    role Afm2Dom {
        ...
        method set-encoding( Str :$!enc = 'win') {
            given $!enc {
                when 'mac' {
                    $!glyphs = $PDF::Doc::Util::Font::Encodings::mac-glyphs;
                    $!encoding = $PDF::Doc::Util::Font::Encodings::mac-encoding;
                }
                when 'win' {
                    $!glyphs = $PDF::Doc::Util::Font::Encodings::win-glyphs;
                    $!encoding = $PDF::Doc::Util::Font::Encodings::win-encoding;
                }
                when 'sym' {
                    $!glyphs = $PDF::Doc::Util::Font::Encodings::sym-glyphs;
                    $!encoding = $PDF::Doc::Util::Font::Encodings::sym-encoding;
                }
                when 'zapf' {
                    $!glyphs = $PDF::Doc::Util::Font::Encodings::zapf-glyphs;
                    $!encoding = $PDF::Doc::Util::Font::Encodings::zapf-encoding;
                }
                default { 
